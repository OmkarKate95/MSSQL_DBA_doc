...
-- 1. In temprory way you can set deadlock flag through DBCC command its a particular session only and globally, 
--	when restart sqlserverices that time its automatically goes to normal state it means desible.

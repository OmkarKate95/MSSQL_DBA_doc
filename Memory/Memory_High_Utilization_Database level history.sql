--Database level histry of memory high utilization
...
SELECT   [db_name] = CASE [database_id] WHEN 32767        THEN 'Resource DB'        
					...
					END,   db_buffer_pages,   db_buffer_MB = db_buffer_pages / 128,   db_buffer_percent = CONVERT(DECIMAL(6,3),        db_buffer_pages * 100.0 / @total_buffer)
